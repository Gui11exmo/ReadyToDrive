...
#define AIR__Pin GPIO_PIN_6
#define AIR__GPIO_Port GPIOA
#define AIR_A7_Pin GPIO_PIN_7
#define AIR_A7_GPIO_Port GPIOA
#define Precarga_Pin GPIO_PIN_12
#define Precarga_GPIO_Port GPIOB
#define Arranque_Pin GPIO_PIN_6
#define Arranque_GPIO_Port GPIOC
#define Freno_Pin GPIO_PIN_8
#define Freno_GPIO_Port GPIOC
#define Descarga_Pin GPIO_PIN_9
#define Descarga_GPIO_Port GPIOC
